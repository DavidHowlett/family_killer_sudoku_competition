...
The second problem was typed by David. The solution is:
    ...
    2 8 3 4 6 5 9 1 7
    5 4 6 7 1 9 8 2 3
Here is the solution, I think, for the "problem dad"
    7 6 1 9 3 8 4 5 2
    2 9 8 5 4 7 3 1 6
    4 5 3 6 2 1 8 7 9
    1 8 6 7 5 4 9 2 3
...
problems = [
    [
        ...
        'problem 2',
        [  # from https://krazydad.com/killersudoku/sfiles/KD_Killer_IN12_8_v50.pdf
            [13, [[0, 0], [0, 1]]],
            [5,  [[1, 0], [1, 1]]],
            [24, [[2, 0], [3, 0], [4, 0], [5, 0]]],
            [6,  [[6, 0], [6, 1]]],
        ...
        [
            ...
            [12, [[7, 4], [7, 5]]],
            [10, [[7, 6], [8, 6], [8, 7]]],
            [27, [[7, 9], [8, 8], [8, 9], [9, 8], [9, 9]]],
            [ 9, [[8, 3], [9, 2], [9, 3]], [11, [8, 4], [8, 5]]],
            [ 8, [[9, 4], [9, 5]]],
            [11, [[9, 6], [9, 7]]]
        ]
    ]
...
grouped_problems = []
for original_name, original_problem in problems:
    to_duplicate = [[original_name, original_problem]]

    # expand problem set with rotational invariance
    for name, problem in to_duplicate.copy():
        to_duplicate.append([
            name + ' rotated', [[_total, [[y, 8-x] for x, y in rule]] for _total, rule in problem]])

    # expand problem set with inversion invariance
    for name, problem in to_duplicate.copy():
        to_duplicate.append([
            name + ' inverted', [[_total, [[8-x, 8-y] for x, y in rule]] for _total, rule in problem]])

    # expand problem set with reflection invariance
    for name, problem in to_duplicate.copy():
        to_duplicate.append([
            name + ' reflected', [[_total, [[8-x, y] for x, y in rule]] for _total, rule in problem]])
    ...
    grouped_problems.extend(to_duplicate)
